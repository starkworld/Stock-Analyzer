...
<h2 align=center> Deliveries List of Godown <%=GodownID%></h2>
<BR><BR>
...
try
{
	...
	stmt =  con.createStatement();
        String Query = "Select ItemName,Quantity,Purpose,BillValue from DeliveryMaster  where (DateOfDelivery between (\'"+strStartDate+"\') and (\'"+strEndDate+"\'))and GodownID=\'"+GodownID+"\'";
...
if(rs!=null)
{
	...
	if(noRows==0){
		%>
			<tr><th align=center>No deliveries between these dates</th></tr>
		<%	
	}
...
<BR><BR>
<center><A class=title HREF="SalesReport.html"> &lt;&lt; BACK </A></center>
</FORM>
</BODY>
</HTML>