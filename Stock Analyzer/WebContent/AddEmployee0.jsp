...
<script type="text/javascript" src="./js/jquery-ui.js"></script>
   ...
   if(!(Ipattern.test(EmpName))){
	...
	if(!(Ipattern.test(CurrentLocation))){
...
%>
  ...
  <FORM NAME="AddEmpForm" onSubmit="return check()" action="AddEmployee.jsp">
   ...
   <TABLE BORDER="0" CELLSPACING="2"  CELLPADDING="2" >
	   ...
	   <TD>JoiningDate* </TD>
	   <TD nowrap>
		<input size=20 id="JoiningDate" name="JoiningDate">
        </TD>
		<TR class=row_even >
			<TD>Role*</TD>
			<TD>
		...
		<TR class=row_odd >
			<td>Godown ID </td>
			<td><input type="text" name="GodownID" size=5 ><input type="button" value="Show Godowns" onclick="fnEmpPopUp('Godownslists.jsp',300,300)"></td>
		</TR>
		<TR class=row_even >
			<TD>Remarks</TD>
