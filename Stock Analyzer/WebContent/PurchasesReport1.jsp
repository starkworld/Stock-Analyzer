...
%>
<body class="SC">
<FORM METHOD=POST ACTION="" NAME="AddInwardsForm">
<center>
...
<h2 align=center> Inwards List of Godown <%=GodownID%></h2>
<BR><BR>
...
try
{
	...
	stmt =  con.createStatement();
        String Query = "Select ItemName,Quantity,BillValue from InwardsMaster  where (DateOfSupply between (\'"+strStartDate+"\') and (\'"+strEndDate+"\')) and GodownID=\'"+GodownID+"\'"; ;
...
if(rs!=null)
{
	...
	if(noRows==0){
		%>
			<tr><th align=center>No Inwards between these dates</th></tr>
		<%	
	}
...
<BR><BR>
<center><A class=title HREF="PurchasesReport.html"> &lt;&lt; BACK </A></center>
</FORM>
</BODY>
</HTML>